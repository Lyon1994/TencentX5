...
import com.tencent.x5.RefreshActivity;
...
public class X5WebView extends WebView {
    ...
    private WebViewClient client = new WebViewClient() {
        ...
        public void onPageFinished(WebView arg0, String arg1) {
            if (pagerListener != null) {
                pagerListener.onPageFinished(arg0, arg1);
            }
        }
        ...
        public void onPageStarted(WebView arg0, String arg1, android.graphics.Bitmap arg2) {
            if (pagerListener != null) {
                pagerListener.onPageStarted(arg0, arg1, arg2);
            }
        }
    ...
    public WebViewClient getPagerListener() {
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (getX5WebViewExtension() != null) {
            if (IS_DEBUG) {
                canvas.drawText(this.getContext().getPackageName() + "-pid:" + android.os.Process.myPid(), 10, 50,
                        paint);
